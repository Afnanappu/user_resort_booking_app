...
class _$SelectLocationImpl implements _SelectLocation {
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(selectedLocation));
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.locationModel, locationModel));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(locationModel));
...
class __$$LocationConfirmedImplCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object? confirmedLocation = freezed,
  }) {
    return _then(_$LocationConfirmedImpl(
      confirmedLocation: freezed == confirmedLocation
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.confirmedLocation, confirmedLocation));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(confirmedLocation));
